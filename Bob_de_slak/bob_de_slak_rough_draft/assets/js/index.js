...
Lava.prototype.update = function(time, state) {
  ...
  if (!state.level.touches(newPos, this.size, "wall") && (!state.level.touches(newPos, this.size, "grass")) && (!state.level.touches(newPos, this.size, "blockshower"))) {
...
Player.prototype.update = function(time, state, keys) {
  ...
  if (!state.level.touches(movedX, this.size, "wall") && (!state.level.touches(movedX, this.size, "grass")) && (!state.level.touches(movedX, this.size, "blockshower"))) {
    pos = movedX;
  }

  let ySpeed = this.speed.y + time * gravity;
  let movedY = pos.plus(new Vec(0, ySpeed * time));
  if (!state.level.touches(movedY, this.size, "wall") && (!state.level.touches(movedY, this.size, "grass")) && (!state.level.touches(movedY, this.size, "blockshower")))  {
    pos = movedY;
